...
- Clone it and install dependencies
		...
		git clone https://github.com/YOUR-USERNAME/metaphasejs
		yarn/npm install

Keep in mind that after running `yarn/npm install` the git repo is reset. So a good way to cope with this is to have a copy of the folder to push the changes, and the other to try them.
